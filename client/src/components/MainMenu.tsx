  ...
  return (
    <div className="relative w-full h-screen bg-white text-gray-800 font-sans overflow-hidden selection:bg-red-100">
        ...
        <motion.h1 
          ...
          className="text-4xl md:text-5xl font-normal tracking-tight text-gray-900 text-center w-1/3"
        >
          Exploding Kauffman
        </motion.h1>
      ...
      <main className="flex flex-col items-center justify-center h-full w-full px-4">
        ...
        > {/* User has to be logged in to join/create a game */}
          <MenuButton onClick={() => user ? navigate('/join') : setShowAuthModal(true)}>
            Join Lobby
          </MenuButton>
          
          <MenuButton onClick={() => user ? navigate('/create') : setShowAuthModal(true)}>
            Create Lobby
          </MenuButton>
